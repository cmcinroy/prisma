...
import com.prisma.api.connector.oracle.Metrics
...
case class OracleDataResolver(
    project: Project,
    readonlyClientDatabase: OracleProfile.backend.DatabaseDef,
    schemaName: Option[String]
)(implicit ec: ExecutionContext)
    extends DataResolver {

  val queryBuilder = OracleApiDatabaseQueryBuilder(project.schema, schemaName = schemaName.getOrElse(project.id))
